...
import "../views/viewsPageCssFile/pagenotfound.css"
...
function PageNotFound() {
    ...
    document.body.style.fontFamily = "'Fira Mono', monospace";
    ...
    function defaultBg() {
        ...
        document.body.style.color = "#E0E0E0";
        document.body.style.fontFamily = "George";
    }
    
    return(
        <>
        <div className='body'>
        <svg  viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg" className='svg'>
            <rect fill="black" className='img'/>
            <g id="sky" filter="url(#filter0_d)">
            <rect id="background" x="30" y="26"  rx="20" fill="black" className='img'/>
            <g id="stars">
    ...
    <div className="text">
      ...
      <h2>Couldn't launch :(</h2>
         <h3>Page Not Found - lets take you <NavLink to={'/'} onClick={defaultBg}>HOME</NavLink></h3> 
    </div>
    </>
    )
}
